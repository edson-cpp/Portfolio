...
private:
    ...
    std::string classSectionTitleMyPortfolio = "text-fs-56 font-black font-Poppins uppercase "
                        "text-white m-0 xs:text-fs-26 xs:text-left xs:leading-lh-1.2";
    std::string classSectionTitleProjects = "text-fs-110 absolute left-0 right-0 top-1/2 tracking-10 "
